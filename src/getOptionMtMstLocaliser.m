...
function opt = getOptionMtMstLocaliser()
    %
...
%                  'model', 'model-MtMstLocalizer_smdl.json');
    opt.model.file =  ...
        fullfile(fileparts(mfilename('fullpath')), '..', ...
                 'model', 'modelNoResponse-MtMstLocalizer_smdl.json');
  ...
  opt.result.Steps(1).Contrasts(1).Name = 'motion_left';
