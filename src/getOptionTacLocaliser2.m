...
function opt = getOptionTacLocaliser2()
    %
 ...
 if nargin < 1
  ...
  opt.subjects = {'001','002','003','004','005','006','007','008','009','010','011','013',...
  ...
  % task to analyze
  opt.taskName = 'tactileLocalizer2'; 
...
%                  'model', 'model-tactileLocalizer2_smdl.json');
    opt.model.file =  ...
        fullfile(fileparts(mfilename('fullpath')), '..', ...
                 'model', 'modelNoResponse-tactileLocalizer2_smdl.json');
